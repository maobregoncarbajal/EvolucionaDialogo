...
function showCalendarObject(el, format) {
	if (calendar != null) {
...
function showCalendar(id, format) {
	...
	showCalendarObject(el, format);
}


function validateInputDate(p_textbox) {

    var SYMBOL_DATE_NUM = 47;
    //Para el '/'
    var SYMBOL_DATE_NUM_CONV = 45;
    //Para el '-'

//    var SYMBOL_HOUR_NUM = 58;
//    //Para el ':'

//    var SYMBOL_DATE = "/";
//    //Puede ser '-' o '/'
//    var SYMBOL_DATE_CONV = "-";
    //Para uso de la BD Oracle solamente
    var SYMBOL_DATE_NUMOUT = SYMBOL_DATE_NUM_CONV;
    //Para el algoritmo de validación de fecha
