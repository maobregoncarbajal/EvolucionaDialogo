...
SimileAjax.DateTime.CAMPANHA = 12;
...
(function() {
    ...
    A[B.QUARTER] = A[B.MONTH] * 3;
    A[B.CAMPANHA] = A[B.DAY] * 20;
})();
...
SimileAjax.DateTime.roundDownToInterval = function(E, B, I, K, A) {
    ...
    switch (B) {
        case SimileAjax.DateTime.MILLISECOND: var H = J.getUTCMilliseconds();
...
SimileAjax.DateTime.incrementByInterval = function(A, D, B) {
    ...
    switch (D) {
        case SimileAjax.DateTime.MILLISECOND: C.setTime(C.getTime() + 1);
            break;
        ...
        case SimileAjax.DateTime.WEEK:
            ...
            break;
        case SimileAjax.DateTime.CAMPANHA: // added this

            C.setUTCDate(C.getUTCDate() + 20);
            var date1 = "01-01-" + C.getUTCFullYear();
            var date2 = C.getUTCDate() + "-" + (C.getUTCMonth() + 1) + "-" + C.getUTCFullYear();
