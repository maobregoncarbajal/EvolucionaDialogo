...
function _prepareFaviconUrl(){if(options.url!=null&&$.trim(options.url)!=""){var domain=getDomain(options.url);if(domain!=null){return'http://'+domain+'/procesosgestion/Images/favicon.ico';}}
return null;}
