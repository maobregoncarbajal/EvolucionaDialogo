...
namespace Evoluciona.Dialogo.Web.Admin.Controls
{
    ...
    public partial class Resumen_Durante_Despues : UserControl
    {
        #region Variables
        ...
        private void CargarZonaAlternativoPorRol(int idProceso)
        {
            ...
            List<BeZonaAlternativa> listaAlternativas = daAlternativa.ObtenerZonaAlternativaPorRol(CadenaConexion, rolUsuarioEvaluado);
            ...
            foreach (BeZonaAlternativa objAlternativa in listaNodosPrincipales)
            {
                ...
                if (objSeleccionado != null && objSeleccionado.Seleccionado.Trim() == "1")
                {
                    ...
                    {
                        lblOtros.Text = objSeleccionado.AlternativaOtro;
                    }
                }
