<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="RepAntCom.aspx.cs" Inherits="Evoluciona.Dialogo.Web.Admin.Reportes.RepAntCom" %>
    ...
    function ListarReporte(listObj, urlExport) {
        ...
        jQuery("#list").jqGrid({
            ...
            colNames: [
                ...
                'Competencia', 'Comportamiento', 'Sugerencia', 'Observación',
            ...
            colModel: [
                ...
                { name: 'Comportamiento', index: 'Comportamiento', width: 100 },
                { name: 'Sugerencia', index: 'Sugerencia', width: 100 },
