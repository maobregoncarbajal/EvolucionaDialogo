<%@ Page Language="C#" MasterPageFile="~/Admin/SiteAdmin.Master" AutoEventWireup="true"
    CodeBehind="ReporteTimeLine.aspx.cs" Inherits="Evoluciona.Dialogo.Web.Admin.Reportes.ReporteTimeLine" Title="Time Line" %>
<%@ Import Namespace="Evoluciona.Dialogo.Web.Helpers" %>

<%@ Register Src="~/Admin/Controls/MenuReportes.ascx" TagName="menuReportes" TagPrefix="uc" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="<%=Utils.AbsoluteWebRoot%>Styles/Validation.css" rel="stylesheet" type="text/css" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div style="float: left; width: 100%;">
            <table>
                <tr>
                    ...
                    <td>
                        <select id="ddlPais" name="ddlPais" class="combo" style="width: 100px;">
                        </select>
                    </td>
                    <td style="width: 100px;">Periodo :
                    </td>
                    <td>
                        <select id="ddlPeriodo" name="ddlPeriodo" class="combo" style="width: 100px;">
                        </select>
                    </td>
                    <td style="width: 100px;">Rol :
                    </td>
                    <td>
                        <select id="ddlRol" name="ddlRol" class="combo" style="width: 100px;">
                        </select>
                    </td>
                    <td style="width: 100px;">Toma Acción :
                    </td>
                    <td>
                        <select id="ddlTipoAccion" name="ddlTipoAccion" class="combo" style="width: 100px;">
                        </select>
                    </td>
        ...
        <table width="100%">
            <tr>
                ...
                <td>
                    ...
                    <div id="tabla1" style="display: none; text-align: right">
    ...
    <script type="text/javascript" language="javascript">
        ...
        var webHandlerMatrizAdmin = "<%=Utils.RelativeWebRoot%>Admin/Matriz/MatrizAdmin.ashx";
        var urlImage = "";
        ...
        $(document).ready(function () {
            ...
            $("#btnBuscar").click(function () {
                ...
                if ($("#ddlPais").val() != "00") {
                    ...
                    MATRIZ.ShowAlert('dialog-alert', "Debe seleccionar un País");
                }
            });

            $("#ddlPais").change(function () {
                MATRIZ.LoadDropDownList("ddlPeriodo", webHandler, { 'accion': 'periodo', 'codPais': $(this).val(), 'anho': '00', idRol: "-1" }, 0, true, false);
            });
        ...
        function initialLoad() {
            tipoAdmin = $("#<%=lblTipoAdmin.ClientID%>").html();
            ...
            MATRIZ.LoadDropDownList("ddlPais", webHandlerMatrizAdmin, { 'accion': 'pais', 'codPais': codPaisEvaluador, 'tipo': tipoAdmin, 'select': 'Seleccionar' }, 0, true, false);
