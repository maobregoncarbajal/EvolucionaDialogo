<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="RepDurNeg.aspx.cs" Inherits="Evoluciona.Dialogo.Web.Admin.Reportes.RepDurNeg" %>
    ...
    function ListarReporte(listObj, urlExport) {
        ...
        jQuery("#list").jqGrid({
            ...
            colNames: [
                ...
                'Var.Enfoque', 'Var.Causa', 'Zonas/Secciones', 'Plan Negocio',
            ...
            colModel: [
                ...
                { name: 'VariableEnfoque', index: 'VariableEnfoque', width: 100 },
                { name: 'VariableCausales', index: 'VariableCausales', width: 100 },
                { name: 'ZonasSecciones', index: 'ZonasSecciones', width: 100 },
                { name: 'PlanNegocio', index: 'PlanNegocio', width: 100 },
