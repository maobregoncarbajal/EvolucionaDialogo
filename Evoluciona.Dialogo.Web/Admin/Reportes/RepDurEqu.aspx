<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="RepDurEqu.aspx.cs" Inherits="Evoluciona.Dialogo.Web.Admin.Reportes.RepDurEqu" %>
    ...
    function ListarReporte(listObj, urlExport) {
        ...
        jQuery("#list").jqGrid({
            ...
            colNames: [
                ...
                'Cod.Priorizada', 'Nombre Priorizada', 'Plan Acción',
            ...
            colModel: [
                ...
                { name: 'PlanAccion', index: 'PlanAccion', width: 100 },
