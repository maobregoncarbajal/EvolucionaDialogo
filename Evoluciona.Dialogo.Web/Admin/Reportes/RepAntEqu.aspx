<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="RepAntEqu.aspx.cs" Inherits="Evoluciona.Dialogo.Web.Admin.Reportes.RepAntEqu" %>
    ...
    function ListarReporte(listObj, urlExport) {
        ...
        jQuery("#list").jqGrid({
            ...
            colNames: [
                ...
                'Cod.Priorizada', 'Nombre Priorizada', 'Var.Considerar',
            ...
            colModel: [
                ...
                { name: 'CodPriorizada', index: 'CodPriorizada', width: 100 },
                { name: 'NombrePriorizada', index: 'NombrePriorizada', width: 100 },
                { name: 'VariableConsiderar', index: 'VariableConsiderar', width: 100 },
