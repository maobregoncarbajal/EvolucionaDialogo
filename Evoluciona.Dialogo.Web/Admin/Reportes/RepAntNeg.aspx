<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="RepAntNeg.aspx.cs" Inherits="Evoluciona.Dialogo.Web.Admin.Reportes.RepAntNeg" %>
    ...
    function ListarReporte(listObj, urlExport) {
        ...
        jQuery("#list").jqGrid({
            ...
            colModel: [
                ...
                { name: 'DesVariableEnfoque', index: 'DesVariableEnfoque', width: 100 },
                { name: 'DesVariableCausa', index: 'DesVariableCausa', width: 100 },
