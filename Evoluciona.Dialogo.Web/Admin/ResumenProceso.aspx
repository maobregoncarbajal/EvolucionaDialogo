<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResumenProceso.aspx.cs"
    Inherits="Evoluciona.Dialogo.Web.Admin.ResumenProceso" ValidateRequest="false" %>

<%@ Register Src="~/Admin/Controls/Resumen_Durante_Despues.ascx" TagName="resumen_dd"
    TagPrefix="uc" %>
        ...
        <div>
            ...
            <div id="tabs" style="font-size: 0.7em;">
                <ul>
                    ...
                    <li id="liTab2"><a href="#tabs-2">DURANTE</a></li>
                    <li id="liTab3"><a href="#tabs-3">DESPUÉS</a></li>
                </ul>
                <div id="tabs-1">
                ...
                <div id="tabs-2">
                    <div style="width: 100%; text-align: left;">
                        <uc:resumen_dd ID="resumen_dd_durante" runat="server" />
                    </div>
                </div>
                <div id="tabs-3">
                    <div style="width: 100%; text-align: left;">
                        <uc:resumen_dd ID="resumen_dd_Despues" runat="server" EstadoProceso="DESPUES" />
                    </div>
                </div>
            </div>
        </div>
