<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/SiteAdmin.Master" AutoEventWireup="true"
    CodeBehind="Bajas.aspx.cs" Inherits="Evoluciona.Dialogo.Web.Admin.Bajas" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">

        function VerificarBaja() {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="roundedDiv divFiltroPeriodo2" style="margin-top: 20px; height: 140px; margin-left: 30px; text-align: left; width: 410px;">
        <table style="margin: 5px; width: 400px; margin-top: 15px;">
            ...
            <tr style="height: 30px;">
                ...
                <td>
                    <asp:Button runat="server" Text="Dar Baja" ID="btnGuardar"
                        Style="margin-left: 0px;" OnClientClick="VerificarBaja();" OnClick="btnGuardar_Click" />
                </td>
                <td></td>
            </tr>
            <tr>
    ...
    <div style="margin: 15px 0 15px 30px; text-align: left; width: 100%" id="contenidoAltas">
        <asp:GridView ID="gvAltas" runat="server" AutoGenerateColumns="False"
            OnPageIndexChanging="gvAltas_PageIndexChanging" AllowPaging="True">
            <EmptyDataTemplate>
                <table>
