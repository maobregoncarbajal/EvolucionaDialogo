...
namespace Evoluciona.Dialogo.Web
{
    ...
    public partial class log_extd : Page
    {
        ...
        private void Login_Evoluciona(string cubEncriptado)
        {
            ...
            else if (cantReg == 1)
            {
                ...
                Response.Redirect("validaciond.aspx?codigoUsuario=" + codigoFfvv + "&prefijoIsoPais=" + pais + "&codigoRol=" + codigoRol + "&IdUsuario=" + Constantes.Token);
