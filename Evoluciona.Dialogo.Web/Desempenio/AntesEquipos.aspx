<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true"
    CodeBehind="AntesEquipos.aspx.cs" Inherits="Evoluciona.Dialogo.Web.Desempenio.AntesEquipos" %>
<%@ Import Namespace="Evoluciona.Dialogo.Web.Helpers" %>

<%@ Register Src="~/Controls/HeaderPaginasOperacion.ascx" TagName="HeaderPaginasOperacion" TagPrefix="uc1" %>
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function () {
            ...
            if(nuevas == "NUEVA") {
                ...
                window.location.href = "<%=Utils.RelativeWebRoot %>Desempenio/AntesCompetencias.aspx";
            }            
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div id="msgProceso" style="font-size: 10pt; font-family: Arial">
        ...
        <br />
        <br />
        Haz click aquí para continuar con el proceso: <a href="<%=Utils.RelativeWebRoot %>Desempenio/AntesCompetencias.aspx" id="urlDestino">DIÁLOGO/ANTES/COMPETENCIAS</a>
    </div>
