...
namespace Evoluciona.Dialogo.Web.Desempenio
{
    ...
    public partial class AntesNegocio : Page
    {
        #region Variables
        ...
        {
            bool esCorrecto = _indicadorBl.InsertarIndicadores(txtIdVariable1.Text, txtIdVariable2.Text,
                ObjResumenBe.idProceso, AnioCampana, 0, CadenaConexion);

            if (esCorrecto)
            {
                esCorrecto = _indicadorBl.InsertarVariablesCausa(IdProceso,
        ...
        private void CargarVariablesCausa()
        {
            ...
            DataTable variablesCausaIndicador1 = _indicadorBl.ObtenerVariablesCausa(IdProceso, txtIdVariable1.Text);
            DataTable variablesCausaIndicador2 = _indicadorBl.ObtenerVariablesCausa(IdProceso, txtIdVariable2.Text);
        ...
        {
            DataSet dsReporte = String.Equals(NmbrEvld, Constantes.Nueva) ? _indicadorBl.CargarindicadoresporperiodoNuevas(cboPeriodosFiltro.SelectedValue.Trim(), CodigoUsuario, IdProceso, CodigoRolUsuario, PrefijoIsoPais, CadenaConexion) : _indicadorBl.Cargarindicadoresporperiodo(cboPeriodosFiltro.SelectedValue.Trim(), CodigoUsuario, IdProceso, CodigoRolUsuario, PrefijoIsoPais, CadenaConexion);
