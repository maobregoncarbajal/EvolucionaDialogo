...
namespace Evoluciona.Dialogo.Web.Desempenio
{
    ...
    public partial class AntesCompetenciasEvaluado : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var dt = daProceso.ObtenerPlanAnualGrabadasPreDialogo(CadenaConexion, _objResumen);
        ...
        protected void lSincronizaDialogo_Click(object sender, EventArgs e)
        {
            var blProceso = new BlProceso();
            var respuesta = blProceso.SincronizarDialogoConPreparacion(_objResumen.idProceso);

            const string message = "Ahora tu preparación forma parte de tu diálogo";
