<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="RegistroAcuerdo.aspx.cs" Inherits="Evoluciona.Dialogo.Web.Desempenio.RegistroAcuerdo" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function listar(varPeriodo) {
            ...
            if (lista.length > 0) {
                ...
                titulo = titulo + "<th>Observaciones</th><th>Eliminar</th></tr>";
                ...
                $.each(lista, function (i, v) {
                    ...
                    tabla = tabla + "<td><img src='<%=Utils.AbsoluteWebRoot%>Styles/Matriz/Delete-icon.png' title='Eliminar' class='DelRow' style='cursor:pointer'id='btnDel-" + v.IdTomaAccion + "'/></td></tr>";
                });
