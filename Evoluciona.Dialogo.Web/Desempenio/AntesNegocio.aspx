<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.master" AutoEventWireup="true"
    CodeBehind="AntesNegocio.aspx.cs" Inherits="Evoluciona.Dialogo.Web.Desempenio.AntesNegocio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="msgProceso" style="font-size: 10pt; font-family: Arial">
        ...
        <%
            ...
            {%>
        <a href="<%=Utils.RelativeWebRoot %>Desempenio/DuranteNegocio.aspx"
            id="urlDestino">DIÁLOGO/DURANTE/NEGOCIO</a>
        <%}
            else
            {%>
        <a href="<%=Utils.RelativeWebRoot %>Desempenio/AntesEquipos.aspx"
            id="urlDestino">DIÁLOGO/ANTES/EQUIPOS</a>
        <%}%>
    </div>
    <div style="margin: 35px 0 0 15px" id="divPaso1Negocio">
        ...
        <div id="contenidoPaso2" runat="server" style="margin: 15px 0 0 35px; text-align: left;">
            ...
            <div style="width: 720px; text-align: right; padding-right: 55px">
                ...
                <asp:HyperLink Text="| Siguiente" ID="hlSiguiente" NavigateUrl="DuranteNegocio.aspx"
