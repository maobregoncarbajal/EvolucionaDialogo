<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResumenAntesEvaluado.aspx.cs" Inherits="Evoluciona.Dialogo.Web.PantallasModales.ResumenAntesEvaluado" %>
...
<body style="font-size: 9pt !important;">
    <form id="form1" runat="server">
        <div id="contentidoImprimir">
            <h3 style="text-align: center; font-family: Arial">Evaluado(a) :
                    ...
                    <tr>
                        <td style="vertical-align: text-top">
                            <table width="520px">
                                <tr>
                                    <td>
                                        <span class="subTituloMorado">Resultados de <%=descRol %>  en las variables del negocio.</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:GridView ID="grdvVariablesBase" Width="500px" runat="server" AutoGenerateColumns="False">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Variable de Enfoque">
                                                    <ItemTemplate>
                                                        <asp:CheckBox Enabled="false" ID="CheckBox1" CssClass="clsChhIndicadores" name="CheckBox1" runat="server" AutoPostBack="false" Checked='<%# Eval("bitEstado")  %>' />
                                                    </ItemTemplate>
                                ...
                                <tr>
                                    <td class='variables'>Variables Adicionales</td>
                                </tr>
                                <tr>
                                    <td style="height: 166px">
                                        <asp:GridView ID="grdvVariablesAdicionales" Width="500px" runat="server" AutoGenerateColumns="False">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Variable de Enfoque">
                                                    <ItemTemplate>
                                                        <asp:CheckBox Enabled="false" ID="CheckBox2" name="CheckBox2" runat="server" AutoPostBack="false" Checked='<%# Eval("bitEstado") %>' />
                                                    </ItemTemplate>
                                                    <HeaderStyle HorizontalAlign="Center" Width="150px" />
                                                    <ItemStyle HorizontalAlign="Center" />
                                                </asp:TemplateField>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DataList ID="dlstResumenCriticas" runat="server" RepeatDirection="Horizontal" Width="200px">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <td>
                                                    <label runat="server" class="texto_morado_brand" id="lblTexto"><%# Eval("vchEstadoPeriodo")%></label>
                                                </td>
                                                <td>
                                                    <label runat="server" class="texto_morado_brand" id="Label1"><%# Eval("%", "{0}%")%></label>
                                                </td>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                </tr></table>
                        ...
                        <td style="vertical-align: text-top">
                            ...
                            <table width="502">
                                <tr>
                                    <td><span class="subTituloMorado">Variables Causales.</span></td>
                                </tr>
                                <tr>
                                    <td>
                                            ...
                                            <tr style="font-size: 9pt; font-family: Arial">
                                                ...
                                                <td align="left" style="width: 100px">
                                                    <asp:Label ID="lblvariable1Desc" runat="server" Text="[Variable no Seleccionada]"
                                                        CssClass="variables_indicadores"></asp:Label></td>
                                            ...
                                            <tr style="font-size: 9pt; font-family: Arial">
                                                ...
                                                <td align="left" style="width: 100px; height: 21px">
                                                    <asp:Label ID="lblvariable2Desc" runat="server" Text="[Variable no Seleccionada]"
                                                        CssClass="variables_indicadores"></asp:Label></td>
                                                <td align="center" style="width: 110px; height: 21px"></td>
                                                <td align="center" style="width: 120px; height: 21px"></td>
                                                <td align="center" style="width: 120px; height: 21px"></td>
                                            </tr>
                                            <tr style="font-size: 9pt; font-family: Arial">
            ...
            <div style="margin-top: 10px;">
                ...
                <div style="margin-left: 5px;">
                    ...
                    <asp:GridView ID="gvPersonasIngresadas" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        Width="500px">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="variableConsiderar" HeaderText="Variables a considerar"></asp:BoundField>
            ...
            <div style="margin-top: 10px;">
                <span style="text-decoration: underline; font-family: Arial"><strong>ANTES COMPETENCIAS :</strong></span>
                <br />
                <br />
                <div style="margin-left: 5px;">
