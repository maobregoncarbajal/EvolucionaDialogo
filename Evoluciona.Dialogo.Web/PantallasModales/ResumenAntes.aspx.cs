...
namespace Evoluciona.Dialogo.Web.PantallasModales
{
    ...
    public partial class ResumenAntes : Page
    {
        ...
        private void CargarAntesEquipos()
        {
            ...
            List<BeCriticas> lstCargarCriticasProcesadas = criticaBL.ListaCargarCriticasProcesadasResumen(objResumenBE.codigoUsuario,
        ...
        private void CargarAntesNegocio()
        {
            ...
            DataTable variablesUtilizadas = indicadorBL.ObtenerVariablesCausaPorProceso(objResumenBE.idProceso);
        ...
        private void GetVariablesBase(BeResumenProceso objResumenBE, string PeriodoCerrado)
        {
            ...
            DataSet dsgrdvVariablesBase = blIndi.Cargarindicadoresporperiodo(PeriodoCerrado, objResumenBE.codigoUsuario, objResumenBE.idProceso, objResumenBE.codigoRolUsuario, objResumenBE.prefijoIsoPais,connstring);
        ...
        private void GetVariablesAdicionales(BeResumenProceso objResumenBE, string PeriodoCerrado)
        {
            ...
            connstring = Session["connApp"].ToString();//ConfigurationManager.ConnectionStrings["cnxDialogoDesempenio"].ToString();
            BlIndicadores blIndi = new BlIndicadores();
            DataSet dsgrdvVariablesAdicionales = blIndi.CargarindicadoresporperiodoVariablesAdicionales(PeriodoCerrado, objResumenBE.codigoUsuario, objResumenBE.idProceso, objResumenBE.codigoRolUsuario, objResumenBE.prefijoIsoPais, connstring);
        ...
        private void CargarPlanAnualGrabadas()
        {
            ...
            dtGrabadas = daProceso.ObtenerPlanAnualGrabadas(connstring, objResumen);
