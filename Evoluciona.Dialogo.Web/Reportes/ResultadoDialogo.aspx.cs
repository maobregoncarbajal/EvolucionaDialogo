...
namespace Evoluciona.Dialogo.Web.Reportes
{
    ...
    public partial class ResultadoDialogo : Page
    {
        ...
        protected void btnBuscarAux_Click(object sender, EventArgs e)
        {
            ...
            dt = reporteBL.ResultadoDialogoUsuario(CadenaConexion, anho, periodo, perioAnteior, nivel, pais, "dialogo", objUsuario.codigoUsuario, GetNivelByIdRol(objUsuario.codigoRol));
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                dtPais = reporteBL.ResultadoDialogoUsuario(CadenaConexion, anho, periodo, perioAnteior, nivel, pais, "dialogoPaises", objUsuario.codigoUsuario, GetNivelByIdRol(objUsuario.codigoRol));
        ...
        protected void btnBuscarDAux_Click(object sender, EventArgs e)
        {
            ...
            DataTable dtDetalle = reporteBL.ResultadoDialogoDetalleUsuario(CadenaConexion, periodo, pais, region.Trim(), zona.Trim(), nivel.Trim(), varialbe.Trim(), tamBrecha.Trim(), objUsuario.codigoUsuario, GetNivelByIdRol(objUsuario.codigoRol));
