<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true"
    CodeBehind="RankingProductividad.aspx.cs" Inherits="Evoluciona.Dialogo.Web.Reportes.RankingProductividad" %>
        ...
        <div id="panelDos">
            <table style="text-align: left; margin-top: 5px; margin-left: 5px; width: 100%">
                ...
                <tr>
                    ...
                    <td style="text-align: left">
                        <asp:DropDownList ID="cboRolesD" runat="server" Width="120px" CssClass="combo" Style="margin-left: 7px;"
                    ...
                    <td style="text-align: left">
                        <asp:DropDownList ID="cboCuadranteD" runat="server" Width="120px" CssClass="combo" />
                        <span style="color: red">&nbsp;(*)</span>
                    </td>
                </tr>
                <tr style="height: 20px">
