...
namespace Evoluciona.Dialogo.Web
{
    ...
    public partial class pruebasUsuario : Page
    {
        ...
        protected void lnkIniciarDialogo_Click(object sender, EventArgs e)
        {
            ...
            string archivo = Server.MapPath("pruebasUsuario.aspx").Replace("pruebasUsuario.aspx", "KeyPublicaDDesempenio.xml");
            Encriptacion objEncriptar = new Encriptacion();
            string variableParaEncriptar = txtDocuIdentidad.Value.Trim() + "|" + txtPrefijoIsoPais.Value.Trim() + "|" + "periodo|" + ddlRoles.SelectedValue.Trim();
        ...
        protected void lnkAdministrar_Click(object sender, EventArgs e)
        {
