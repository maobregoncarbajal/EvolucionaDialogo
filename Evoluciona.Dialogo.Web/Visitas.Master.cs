...
namespace Evoluciona.Dialogo.Web
{
    ...
    public partial class Visitas : MasterPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            lblRolUsuario.Text = objUsuario.rolDescripcion;
            Session["periodosValidos"] = (new BlPeriodos()).ObtenerPeriodos(objUsuario.prefijoIsoPais);
