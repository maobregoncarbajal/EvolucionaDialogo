...
namespace Evoluciona.Dialogo.Web
{
    ...
    public partial class validaciond : Page
    {
        ...
        private void ValidarUsuario()
        {
            ...
            string urlInicio = "Desempenio/ResumenProceso.aspx";
            //if (Request["app"] != null)
            //{
            ...
            {
                string archivo = Server.MapPath("validaciond.aspx").Replace("validaciond.aspx", "KeyPrivadaDDesempenio.xml");
